...
import { ArrowLeft, ExternalLink, ShieldAlert, Cpu, Layers, Activity, Database, CheckCircle2 } from "lucide-react";
import { PROJECTS } from "@/data/portfolio-data";
import GlofVisual from "@/components/glof-visual";
import ArchitectureDiagram from "@/components/architecture-diagram";
import { GithubIcon } from "@/components/icons";

export const metadata = {
  title: "GLOF Sentinel — Case Study | Selvamani M",
  description: "AI-based early warning system for predicting Glacial Lake Outburst Flood risk using Random Forest, Explainable AI, and GIS visualization.",
};

export default function GlofSentinelCaseStudy() {
  const project = PROJECTS.find((p) => p.id === "glof-sentinel")!;
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-mono font-bold text-white flex items-center gap-2">
            ...
            <span>Interactive GIS &amp; Risk Dashboard Preview</span>
          </h2>
          <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-black">
            <div className="relative aspect-video w-full overflow-hidden">
              <Image
                src="/project-images/glof-sentinel.jpg"
                alt="GLOF Sentinel Dashboard"
                fill
        ...
        <div className="rounded-3xl glass-bento p-6 sm:p-8 space-y-6">
